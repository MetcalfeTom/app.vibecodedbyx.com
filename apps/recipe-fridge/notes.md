...
## log
- 2026-06-29: **+20 Pakistani & +20 Chinese dishes** (chat ask). Recipes 44 → **84**; ingredients 39 → **64**. Because the matcher rejects any recipe ingredient not in the grid, I added 25 new ingredients across 4 new categories + 2 proteins/yogurt/naan, and expanded the assumed **BASICS** to a full spice rack so the curries/stir-fries actually surface.
  - **New ingredients**: proteins pork, lamb; dairy yogurt; pantry naan; *Aromatics & Greens* (ginger, green_chili, scallion, cilantro, bok_choy, eggplant); *Legumes & Nuts* (chickpeas, lentils, peanuts); *Asian Sauces* (hoisin, oyster_sauce, doubanjiang/chili-bean-paste, sesame_oil, vinegar); *Spice Rack* (cumin, coriander, turmeric, garam_masala, chili_powder, five_spice, cornstarch — rendered as colored-square chips).
  - **BASICS** now = butter, olive_oil, ginger, cumin, coriander, turmeric, garam_masala, chili_powder, five_spice, cornstarch, sesame_oil, vinegar. Rationale: dried spices + ginger/sesame-oil/vinegar/cornstarch are "you probably have these," so they don't block matches; fresh/distinguishing items (proteins, chickpeas, lentils, yogurt, scallion, green_chili, cilantro, bok_choy, eggplant, peanuts, hoisin, oyster_sauce, doubanjiang) stay real toggles. Label updated to "(oil, butter, spices)".
  - **Pakistani (20)**: Chicken Biryani, Beef Nihari, Chicken Haleem, Chana Chaat, Chicken Karahi, Aloo Keema, Daal Chawal, Seekh Kebab, Chapli Kebab, Chicken Tikka, Aloo Gosht, Palak Paneer, Chicken Korma, Chana Masala, Vegetable Pulao, Masala Omelette, Chicken Paratha Roll, Chicken Pulao, Egg Curry, Saag.
  - **Chinese (20)**: Mapo Tofu, Kung Pao Chicken, Sweet & Sour Pork, Sesame Chicken, Dim Sum Pork Dumplings, Egg Fried Rice, Chicken Chow Mein, Beef & Broccoli, Char Siu Pork, Veg Spring Rolls, Hot & Sour Soup, Wonton Soup, Egg Drop Soup, Dan Dan Noodles, Eggplant in Garlic Sauce, Lemon Chicken, Scallion Pancakes, Garlic Bok Choy, Shrimp Lo Mein, Twice-Cooked Pork.
  - Simplifications to keep the grid sane: paneer→cheese, paratha wrapper→tortilla, wheat/barley in haleem→oats, spring-roll/wonton wrappers→flour. Spice lists trimmed to ~2 representative spices per dish so cards stay readable.
  - Verified: JS syntax OK; **84 recipes, 64 ingredients, 0 orphan ingredients, all BASICS valid** (cross-check script).
