...
## features
- Flap-to-fly dragon (tap/click/space)
- Canvas-drawn dragon with animated wings and wavy tail
- Parallax neon forest background (2 tree layers + stars)
- Obsidian pillars with crystal edge details
- 5 gem colors with different point values
- Speed increases with distance
- Gem bobbing animation
- Particle effects on collect/death
- Score from pillars passed + gems collected
- Green trail effect behind Kinu

## issues
- None known

## todos
- Supabase leaderboard (high scores)
