...
- 2026-09-26: phones can walk — stick bottom-left, JUMP button bottom-right; the info card shrinks to a one-line touch guide on touch screens (keyboard lines hidden).

## issues
- touch: look = drag on the world (identifier-tracked, so the stick finger never turns the camera).
