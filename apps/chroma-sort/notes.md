...
## log
- 2026-04-10: Intensified music for Ultra/Disaster modes. Ultra: +12 BPM, snare hits, 16th-note hats, countermelody harmony. Disaster: +28 BPM, double kicks, 16th-note melodies, acid bass filter sweeps, glitch stutter blips, 6-note ascending+descending arpeggios every 4 beats, sub-bass octave layer, snare body tone. Melody regenerates faster.
...
## features
- 100 named colors in pool
- 7 difficulty levels (6/9/12/16/36/49/100 tiles)
