...
## log
- 2026-04-10: Added QWERTY substitution cipher (now 10 total). Maps A→Q, B→W, C→E etc — alphabet to keyboard layout. Fixed substitution, re-rolls to new cipher on shift timer.
...
## features
- 10 cipher types (Caesar, Reverse, Atbash, Skip, Vigenere, Pair Swap, Rail Fence, Columnar, Scytale, QWERTY)
