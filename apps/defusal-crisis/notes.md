...
## log
- 2026-04-13: Added Piano Keys module (9th module). 12 colorful keys (chromatic rainbow), 4-note sequence playback with WebAudio sine tones. Translation rules based on serial vowel (+2 position shift) and SND indicator (mirror). Wrong press = strike + replay. Full manual entry with rules.
- 2026-04-12: Added Colored Squares module (8th module). 4x4 green-dominant grid (green/lime/emerald/teal variants), 4-step solve with serial/indicator rules, Manhattan distance nearest-finding. Duck quack sound effect on strikes using WebAudio synthesis.
