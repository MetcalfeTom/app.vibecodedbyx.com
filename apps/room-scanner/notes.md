...
- 2026-09-26: og.png (designed card: label-tape title, 10:00 LCD, 72→18 score chips) replaces the remote pollinations og:image; og:url → app.sloppy.live; shorter og:description
