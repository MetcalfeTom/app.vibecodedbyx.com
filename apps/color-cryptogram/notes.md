...
## log
- 2026-04-11: Added Pangram mode — 28 phrases that use all 26 letters (the ultimate challenge). 5 hints instead of 3 to compensate for full alphabet.
...
- 4 puzzle modes: Words, Phrases, Quotes, Pangrams
- ~80 words, ~40 phrases, ~20 quotes, ~28 pangrams
