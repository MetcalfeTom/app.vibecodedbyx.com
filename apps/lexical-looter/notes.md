...
First-person shooter where you blast typos, grammar errors, and bad punctuation out of existence.
...
- 23 error enemies + 12 decoy correct words (no labels — true skill test!)
- Shooting correct words penalizes: -pts, -8HP, breaks combo
- 3 boss types every 5 waves
- 3 pixel-art weapons: Red Pen, Grammar Hammer, Syntax Shotgun (unlock at waves 3 & 6)
