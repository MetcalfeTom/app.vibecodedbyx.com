...
## features
- Massive canvas-rendered jagged black gear
- 1,000,000 click goal
- 500 unique venomous insults — random one on every click
- 20 milestone messages at various thresholds
...
- localStorage persistence (clicks + total time)
- Vignette overlay
...
- Gear visual degradation over time
