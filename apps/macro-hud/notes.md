...
## log
- 2026-07-06: v1.2 — Firefox fix (chat report): 🎨/⚙ emoji in the bar buttons replaced with inline SVG icons (palette + gear, stroke=currentColor so theme colors apply) — emoji glyph rendering in buttons is unreliable in Firefox depending on platform emoji fonts.
