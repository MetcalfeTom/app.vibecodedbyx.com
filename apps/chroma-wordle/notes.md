...
## log
- 2026-04-11: Changed purple rule from ±1 to exactly ±2 positions away per chat request.
...
- 5 feedback colors (unique to this clone):
  ...
  - Yellow: letter exists in word but not nearby
  - Purple: correct letter, exactly 2 positions away
