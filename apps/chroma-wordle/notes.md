...
## log
- 2026-04-11: Re-added purple rule (±1 position) per chat vote. Now 5 colors again: green/yellow/purple/orange/gray.
- 2026-04-11: Expanded word lists from ~1700 to ~4870 total words (1776 five-letter, 1621 six-letter, 1472 seven-letter).
...
## features
- 5 feedback colors (unique to this clone):
  - Green: exact letter, exact position
  - Yellow: letter exists in word but wrong position
  - Purple: correct letter, exactly ±1 position away
...
## issues
- Dictionary expanded to ~4870 words (1776/1621/1472 per length)
