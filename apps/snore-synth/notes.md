...
## log
- 2026-04-21: Boosted keyboard pad oscillators 10× (`vol` 0.18 → 1.8) per public request. Tightened compressor (threshold -24dB, ratio 14:1, 3ms attack, 220ms release) to act as a hard limiter and protect the master. Perceived loudness jumps dramatically while peaks stay bounded; mute chip still cuts instantly.
