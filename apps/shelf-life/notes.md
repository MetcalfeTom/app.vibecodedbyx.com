...
- 2026-08-18 (12): v2.0 — DAIRY PROFILES + cheddar-vs-carrot per chat, tested conservatively.
  - New EXCLUSIVE 'cheddar-gold' family (h 36–48, sa>.35, l .55–.82 → cheese, butter) carved between carrot-orange (now h<36, l≤.62) and banana-yellow. The honest split is LIGHTNESS: cheddar gold is pale where carrot orange is deep. Bench: cheddar block (240,180,90) → cheese+butter, never carrot; real carrot (237,145,33) still carrot; banana (250,225,80) still banana, never cheese.
