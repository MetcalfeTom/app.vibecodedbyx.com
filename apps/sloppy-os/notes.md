...
- Icon gradients match app themes
- OS-style UI with top bar and taskbar

## apps included
1. Secret Shredder - red/orange
2. Bug Zap - cyan/magenta
3. Tech Church - gold/purple
4. Neon Weather - blue/cyan
5. Neon Aquarium - blue/magenta
6. Pixel Bonfire - orange/red
7. Terminal Escape - green
8. Candle Sailor - dark blue
9. SLOPPY Dashboard - magenta/green
10. BAGS Tracker - green
11. Rugpull Simulator - red
12. Cowsay - white

## todos
- Add window system for opening apps inline
- Add right-click context menu
- Add desktop wallpaper selector
- Add notification system
- Add app search
- Save taskbar pins to localStorage
